...
class DatabaseTableComparatorTest extends TestCase
{
    ...
    public function testCompareSameTables()
    {
        ...
        $c3 = new Column('Foo');
        $c3->getTypeMapping()->copy($this->platform->buildColumnTypeMapping(ColumnType::DOUBLE));
        $c3->getTypeMapping()->setScaleToValueIfNotNull(2);
        $c3->getTypeMapping()->setSizeToValueIfNotNull(3);
        $c3->setNotNull(true);
        $c3->getTypeMapping()->createDefaultValue(123);
        $t3->addColumn($c3);
        $d2->addTable($t3);
        $t4 = new Table('Bar');
        $d2->addTable($t4);
    ...
    public function testCompareSeveralRenamedSameTables()
    {
        ...
        $t1 = new Table('table1');
        $c1 = new Column('col1');
        $c1->getTypeMapping()->copy($this->platform->buildColumnTypeMapping(ColumnType::INTEGER));
        $t1->addColumn($c1);
        $d1->addTable($t1);
        $t2 = new Table('table2');
        $c2 = new Column('col1');
        ...
        $t3 = new Table('table3');
        $c3 = new Column('col1');
        $c3->getTypeMapping()->copy($this->platform->buildColumnTypeMapping(ColumnType::INTEGER));
        $t3->addColumn($c3);
        $d1->addTable($t3);
        ...
        $t4 = new Table('table4');
        $c4 = new Column('col1');
        $c4->getTypeMapping()->copy($this->platform->buildColumnTypeMapping(ColumnType::INTEGER));
        $t4->addColumn($c4);
        $d2->addTable($t4);
        $t5 = new Table('table5');
        $c5 = new Column('col1');
        ...
        $t6 = new Table('table3');
        $c6 = new Column('col1');
        $c6->getTypeMapping()->copy($this->platform->buildColumnTypeMapping(ColumnType::INTEGER));
        $t6->addColumn($c6);
        $d2->addTable($t6);
