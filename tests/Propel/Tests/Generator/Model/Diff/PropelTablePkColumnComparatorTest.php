...
class PropelTablePkColumnComparatorTest extends TestCase
{
    ...
    public function testCompareAddedPkColumn()
    {
        ...
        $t2->addColumn($c2);
        $c3 = new Column('Bar');
        $c3->getTypeMapping()->copy($this->platform->buildColumnTypeMapping(ColumnType::LONGVARCHAR));
        $t2->addColumn($c3);
    ...
    public function testCompareRemovedPkColumn()
    {
        ...
        $t1->addColumn($c1);
        $c2 = new Column('Bar');
        $c2->getTypeMapping()->copy($this->platform->buildColumnTypeMapping(ColumnType::LONGVARCHAR));
        $t1->addColumn($c2);
        $t2 = new Table('');
