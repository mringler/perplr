...
EOF;
    ...
    public static function providerForTestGetRenameColumnDDL()
    {
        ...
        $c2 = new Column('bar2');
        $c2->getTypeMapping()->setColumnType(ColumnType::DOUBLE);
    ...
    public static function providerForTestGetModifyColumnsDDL()
    {
        ...
        $t1->addColumn($c1);
        $c2 = new Column('bar2');
        $c2->getTypeMapping()->setColumnType(ColumnType::INTEGER);
        ...
        $t2->addColumn($c3);
        $c4 = new Column('bar2');
        $c4->getTypeMapping()->setColumnType(ColumnType::INTEGER);
...
EOF;
    ...
    public static function providerForTestGetModifyColumnRemoveDefaultValueDDL()
    {
        ...
        $c1 = new Column('');
        $c1->setName('test');
        $c1->getTypeMapping()->setColumnType(ColumnType::INTEGER);
