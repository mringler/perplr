...
EOF;
    ...
    public static function providerForTestGetRenameColumnDDL()
    {
        ...
        $c1 = new Column('bar1');
        $c1->getDomain()->setMappingType(ColumnType::DOUBLE);
        ...
        $c2 = new Column('bar2');
        $c2->getDomain()->setMappingType(ColumnType::DOUBLE);
    ...
    public static function providerForTestGetModifyColumnDDL()
    {
        ...
        $t1->setIdentifierQuoting(true);
        $c1 = new Column('bar');
        $c1->getDomain()->copy(static::getPlatform()->getDomainForType(ColumnType::DOUBLE));
        $c1->getDomain()->replaceSize(2);
        $t1->addColumn($c1);
        $t2 = new Table('foo');
        $t2->setIdentifierQuoting(true);
        $c2 = new Column('bar');
        $c2->getDomain()->copy(static::getPlatform()->getDomainForType(ColumnType::DOUBLE));
    ...
    public static function providerForTestGetModifyColumnsDDL()
    {
        ...
        $t1->addColumn($c1);
        $c2 = new Column('bar2');
        $c2->getDomain()->setMappingType(ColumnType::INTEGER);
        ...
        $t2->setIdentifierQuoting(true);
        $c3 = new Column('bar1');
        $c3->getDomain()->copy(static::getPlatform()->getDomainForType(ColumnType::DOUBLE));
        $c3->getDomain()->replaceSize(3);
        $t2->addColumn($c3);
        $c4 = new Column('bar2');
        $c4->getDomain()->setMappingType(ColumnType::INTEGER);
...
EOF;
    ...
    public static function providerForTestGetModifyColumnRemoveDefaultValueDDL()
    {
        ...
        $c1 = new Column('');
        $c1->setName('test');
        $c1->getDomain()->setMappingType(ColumnType::INTEGER);
