...
EOF;
    ...
    public static function providerForTestGetRenameColumnDDL()
    {
        ...
        $c2 = new Column('bar2');
        $c2->getTypeMapping()->setMappingType(ColumnType::DOUBLE);
        $c2->getTypeMapping()->setSqlType('DOUBLE');
        $c2->getTypeMapping()->setSizeToValueIfNotNull(2);
        $t2->addColumn($c2);
    ...
    public static function providerForTestGetModifyColumnsDDL()
    {
        ...
        $t1->addColumn($c1);
        $c2 = new Column('bar2');
        $c2->getTypeMapping()->setMappingType(ColumnType::INTEGER);
        $c2->getTypeMapping()->setSqlType('INTEGER');
        $t1->addColumn($c2);
        ...
        $t2->setIdentifierQuoting(true);
        $c3 = new Column('bar1');
        $c3->getTypeMapping()->copy(static::getPlatform()->buildColumnTypeMapping(ColumnType::DOUBLE));
        $c3->getTypeMapping()->setSizeToValueIfNotNull(3);
        $t2->addColumn($c3);
        $c4 = new Column('bar2');
        $c4->getTypeMapping()->setMappingType(ColumnType::INTEGER);
        $c4->getTypeMapping()->setSqlType('INTEGER');
        $c4->setNotNull(true);
        $t2->addColumn($c4);
...
EOF;
    ...
    public static function providerForTestGetModifyColumnRemoveDefaultValueDDL()
    {
        ...
        $c1 = new Column('');
        $c1->setName('test');
        $c1->getTypeMapping()->setMappingType(ColumnType::INTEGER);
