...
EOF;
    ...
    public static function providerForTestGetUniqueDDL()
    {
        ...
        $column1->getDomain()->copy(new Domain(ColumnType::INTEGER));
        $table->addColumn($column1);
        $column2 = new Column('bar2');
        $column2->getDomain()->copy(new Domain(ColumnType::VARCHAR));
    ...
    public static function providerForTestGetForeignKeysDDL()
    {
        ...
        $column3->getDomain()->copy(new Domain(ColumnType::BLOB));
        $table1->addColumn($column3);
        $table3 = new Table('baz');
        $db->addTable($table3);
        $column4 = new Column('id');
        $column4->getDomain()->copy(new Domain(ColumnType::BINARY));
