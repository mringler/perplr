...
class RelationMapTest extends TestCase
{
    ...
    public function testColumns()
    {
        ...
        $tmap1 = new TableMap('foo', $this->databaseMap);
        $col1 = $tmap1->addColumn('FOO1', 'Foo1PhpName', ColumnType::INTEGER);
        $tmap2 = new TableMap('bar', $this->databaseMap);
        $col2 = $tmap2->addColumn('BAR1', 'Bar1PhpName', ColumnType::INTEGER);
        ...
        $col3 = $tmap1->addColumn('FOOFOO', 'FooFooPhpName', ColumnType::INTEGER);
        $col4 = $tmap2->addColumn('BARBAR', 'BarBarPhpName', ColumnType::INTEGER);
